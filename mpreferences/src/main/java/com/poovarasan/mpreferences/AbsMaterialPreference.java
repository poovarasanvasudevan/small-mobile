...
import com.poovarasan.mpreferences.io.UserInputModule;
import com.poovarasan.mpreferences.util.CompositeClickListener;
...
abstract class AbsMaterialPreference<T> extends LinearLayout {
     ...
     * It is not a key.
     */
    public int addPreferenceClickListener(OnClickListener listener) {
    ...
    public void removePreferenceClickListener(OnClickListener listener) {
