...
import com.poovarasan.mpreferences.view.ColorView;

import static com.poovarasan.mpreferences.R.styleable.*;
import static com.poovarasan.mpreferences.view.ColorView.SHAPE_CIRCLE;
...
public class MaterialColorPreference extends AbsMaterialPreference<Integer> implements
        UserInputModule.Listener<Integer>, View.OnClickListener {
