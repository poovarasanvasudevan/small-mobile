...
/**
 * Useful for asynchronous/synchronous loading of network images. This is different in a way that
 * this helper can be used for any view. All you have to do is implement the callback to set any
 * property which accepts drawable as a param. Pass the drawable callback to get the loaded
 * drawable.
 */
public class NetworkDrawableHelper {
     ...
     * @param view            The view which is going to show the drawable. This view will be used
     *                        to start and stop image loading when view is added and removed from
     *                        window. Only used when <code>loadImmediately</code> is set to false.
     *                        Will also work if view is set to null.
     * @param url             The url to load
     * @param loadImmediately Set this to true to load the image on the calling thread
     *                        (synchronous). If false, volley's thread will be used.
     * @param callback        Implement this to get a hold of the loaded bitmap or the error
     *                        reason.
     */
