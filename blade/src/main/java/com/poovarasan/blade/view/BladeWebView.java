 ...
 */
public class BladeWebView extends android.webkit.WebView implements BladeView {
    ...
    public BladeWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BladeWebView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public BladeWebView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
