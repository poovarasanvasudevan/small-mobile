 ...
 */
public class BladeHorizontalProgressBar extends com.poovarasan.blade.view.custom.HorizontalProgressBar implements BladeView {

    private BladeViewManager viewManager;

    public BladeHorizontalProgressBar(Context context) {
        super(context);
    }
