...
public class BladeImageView extends android.widget.ImageView implements BladeView {
    ...
    public BladeImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BladeImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public BladeImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
