 ...
 */
public class BladeViewPager extends android.support.v4.view.ViewPager implements BladeView {

    private BladeViewManager viewManager;

    public BladeViewPager(Context context) {
        super(context);
    }

    public BladeViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
