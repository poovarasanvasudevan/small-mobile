 ...
 */
public class BladeFixedRatingBar extends com.poovarasan.blade.view.custom.FixedRatingBar implements BladeView {

    private BladeViewManager viewManager;

    public BladeFixedRatingBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public BladeFixedRatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BladeFixedRatingBar(Context context) {
        super(context);
    }
