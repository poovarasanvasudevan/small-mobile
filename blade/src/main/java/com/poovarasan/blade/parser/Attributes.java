...
public class Attributes {
    ...
    public static void main(String[] args) throws NoSuchFieldException, IllegalAccessException {
        ...
        Field[] fields = Attribute.Priority.class.getFields();
    ...
    public static class View {
        ...
        public static Attribute OnLongClick = new Attribute("onLongClick");
        ...
        public static Attribute Enabled = new Attribute("enabled", Attribute.Priority.LOW);
        public static Attribute Style = new Attribute("style", Attribute.Priority.MEDIUM);
    }
