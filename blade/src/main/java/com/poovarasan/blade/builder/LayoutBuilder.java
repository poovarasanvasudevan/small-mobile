...
public interface LayoutBuilder {
    ...
    /**
     * This method is used to process the attributes from the layout and set them on the {@link
     * View} that is being built.
     *
     ...
     * @param layout The {@link JsonObject} which defines the layout for the {@link View} to be
     *               built.
     * @param data   The {@link JsonObject} which will be used to replace bindings with values in
     *               the {@link View}.
     ...
     * Generator which will be available with the Layout Builder. This is similar to R.id auto
     * generated
     *
    ...
    /**
     * All consumers of this should ensure that they save the instance state of the ID generator
     * along with the activity/ fragment and resume it when the Layout Builder is being
     * re-initialized
     *
     ...
     * set the {@link com.poovarasan.blade.toolbox.BitmapLoader} for the
     * {@link com.poovarasan.blade.builder.LayoutBuilder}
     *
     * @param bitmapLoader {@link com.poovarasan.blade.toolbox.BitmapLoader} to use for loading
     *                     images.
     */
